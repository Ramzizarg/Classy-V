...
/**
 * Live "people on the site now" indicator for the back office (Shopify-style).
 */
          ...
          <div className="fixed inset-0 z-[120] flex items-end justify-center sm:items-center p-0 sm:p-4">
            ...
            >
              <div className="flex items-center justify-between border-b border-zinc-200 px-4 py-3">
                <div>
                  <h2 className="text-sm font-bold text-black">Visitors by page</h2>
                  <p className="text-xs text-zinc-500">{peopleLabel} · most to least</p>
                </div>
                <button
                  type="button"
                  onClick={() => setPopupOpen(false)}
              ...
              <div className="min-h-0 flex-1 overflow-y-auto px-4 py-3">
                {pages.length === 0 ? (
                  <p className="py-8 text-center text-sm text-zinc-500">No active visitors right now.</p>
                ) : (
