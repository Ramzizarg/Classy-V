...
const BUILD_MARKER_KEY = "classyv:app-build-id";

/** localStorage keys that cache CMS/content and can hide post-deploy UI updates. */
const DEPLOY_INVALIDATED_LOCAL_KEYS = [
  "classyv-home-content",
  "classyv-coming-soon-settings",
] as const;

const DEPLOY_INVALIDATED_SESSION_KEYS = ["classyv:storefront-catalog"] as const;
